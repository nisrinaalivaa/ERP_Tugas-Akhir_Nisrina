    ...
    <footer class="main-footer">
        <div class="footer-left">
            ERP &copy; Kelas B <div class="bullet"></div> Design By <a href="https://nauval.in/">Nisrina Nuraini Aliva 12030120140126</a>
        </div>
        <div class="footer-right">
            Dibuat dengan <i class="fas fa-heart text-danger"></i></a>
        </div>
    </footer>